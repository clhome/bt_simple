...
if [ ! -d ${SERVER_ROOT}/openssl35/lib64 ] && [ -d ${SERVER_ROOT}/openssl35/lib ]; then
    ln -sf ${SERVER_ROOT}/openssl35/lib ${SERVER_ROOT}/openssl35/lib64
elif [ ! -d ${SERVER_ROOT}/openssl35/lib ] && [ -d ${SERVER_ROOT}/openssl35/lib64 ]; then
    ln -sf ${SERVER_ROOT}/openssl35/lib64 ${SERVER_ROOT}/openssl35/lib
fi
