...
Install_App()
{
	...
	if [ ! -f $serverPath/source/webstats/GeoLite2-City.mmdb ];then
		if [ "$LOCAL_ADDR" == "cn" ];then
			wget --no-check-certificate -O $serverPath/source/webstats/GeoLite2-City.mmdb https://mirror.ghproxy.com/https://github.com/P3TERX/GeoLite.mmdb/releases/download/${GEO_VERSION}/GeoLite2-City.mmdb
		else
