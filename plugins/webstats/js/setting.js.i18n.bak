		...
		<div class="ws_setting">\
			...
			<div class="ws_content" style="width:570px;">\
				...
				<p style="margin-top:10px">\
					<button type="button" class="btn btn-success btn-sm" id="submitSetting">' + pt('保存') + '</button>\
					<button type="button" class="btn btn-default btn-sm" id="setAll" style="margin-left: 10px;">' + pt('同步所有站点') + '</button>\
