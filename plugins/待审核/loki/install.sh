...
# cd /www/server/yufeng_panel/plugins/loki && /bin/bash install.sh install 3.5.3
# cd /www/server/yufeng_panel && python3 /www/server/yufeng_panel/plugins/loki/index.py start
