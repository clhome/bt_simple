...
# cd /www/server/yufeng_panel/plugins/grafana && /bin/bash install.sh install 12.1.0
# cd /www/server/yufeng_panel && python3 /www/server/yufeng_panel/plugins/grafana/index.py start
