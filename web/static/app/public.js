...
function tasklist(){
	var con='<ul class="cmdlist" style="margin: 0; padding: 0; max-height: 480px; overflow: auto;"></ul><div style="margin-top: 10px; text-align: center; color: #999;">若任务长时间未执行，请尝试在首页点【重启面板】来重置任务队列</div>';
