    ...
    success: function (layero, index) {
      ...
      if (canEl) {
        canEl.addEventListener('contextmenu', function (e) {
          ...
          var menudiv = '                        <div id="term-paste-bubble" style="position: absolute; z-index: 29891015; padding: 6px 10px; background: rgba(30, 30, 30, 0.85); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px); border: 1px solid rgba(255, 255, 255, 0.15); border-radius: 6px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.36);">                            <input type="text" id="term-paste-input" placeholder="快捷粘贴：请在此处 Ctrl+V 并回车发送" style="width: 250px; background: transparent; border: none; outline: none; color: #fff; font-size: 13px; font-family: Consolas, monospace;" autocomplete="off" />                        </div>';
          $("body").append(menudiv);
