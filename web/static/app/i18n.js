...
(function(window, document) {
    ...
    var FALLBACK_MAP = {
        'reboot_server_title': '重启/修复 服务器',
        'reboot_server': '重启服务器',
        'reboot_panel': '重启面板',
        'reboot_repair_btn': '修复服务器',
        'reboot_repair_tip': '注意：修复服务器会覆盖安装bt_simple面板',
        'reboot_panel_title': '重启面板服务',
        'reboot_panel_confirm': '即将重启面板服务，继续吗？',
        'reboot_panel_wait_msg': '面板正在重启中，请等待... <span id="restart-countdown">{1}</span> 秒',
        'reboot_repair_dialog_title': '修复服务器',
        'reboot_repair_confirm': '确定要修复服务器吗？这将会重新覆盖安装当前版本的面板文件。',
        'reboot_repair_badge': '系统修复',
        'reboot_repair_preparing': '正在准备修复系统核心文件...',
        'reboot_server_safe_title': '安全重启服务器',
        'reboot_server_container_tip': '注意：若您的服务器是一个容器，请取消。',
        'reboot_server_safe_desc': '安全重启有利于保障文件安全，将执行以下操作：',
        'reboot_step_stop_web': '1. 停止Web服务',
        'reboot_step_stop_mysql': '2. 停止MySQL服务',
        'reboot_step_reboot_server': '3. 开始重启服务器',
        'reboot_step_wait_server': '4. 等待服务器启动',
        'reboot_status_stopping_web': '正在停止Web服务...',
        'reboot_status_stopping_mysql': '正在停止MySQL服务...',
        'reboot_status_starting_reboot': '开始重启服务器...',
        'reboot_status_waiting_start': '等待服务器启动...',
        'reboot_status_success': '服务器重启成功!...',
        'file_name': '文件名',
        'size': '大小',
        'last_modified': '修改时间',
        'permissions': '权限',
