...
# cd /www/server/yufeng_panel/plugins/prometheus && /bin/bash install.sh install 3.5.0
# cd /www/server/yufeng_panel && python3 /www/server/yufeng_panel/plugins/prometheus/index.py start
