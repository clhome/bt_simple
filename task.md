...
- [x] 在 `web/utils/plugin.py` 中新增 `downloadPluginFromGithub` 恢复函数，并在强制删除分支中调用 @done(2026-06-10 12:24)
- [x] 优化恢复源：将拉取源由固定 `master.zip` 升级为**优先获取最新稳定 Release**（如果获取失败则 Fallback 自动回退至 `master.zip` 进行容灾） @done(2026-06-10 12:28)
- [x] 验证整体功能是否正常 @done(2026-06-10 12:28)
