...
- [x] 解决慢网络下图标字体加载警告
  - [x] 修改 `web/static/css/site.css` 重写 Glyphicons Halflings 字体声明，采用 `font-display: block` 属性

- [x] 更新近两天 Git 提交内容相关的文档
  - [x] 制定并发布 Implementation Plan
  - [x] 更新 README.md，补充最近 2 天的核心优化与新特性
  - [x] 更新 RELEASE_TEMPLATE.md，补充最近 2 天版本的重大变更日志
  - [x] 更新 说明书.md，补充强杀 PHP 进程、MySQL 校验、网站列表还原接管以及 CodeMirror 等体验改善说明
