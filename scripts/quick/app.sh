...
if [ ! -d /www/server/openresty ];then
	cd /www/server/yufeng_panel/plugins/openresty && bash install.sh install 1.25.3
else
...
if [ ! -d /www/server/redis ];then
	cd /www/server/yufeng_panel/plugins/redis && bash install.sh install 7.4.3
else
...
if [ ! -d /www/server/php/74 ];then
	cd /www/server/yufeng_panel/plugins/php && bash install.sh install 74
else
...
if [ ! -d /www/server/swap ];then
	cd /www/server/yufeng_panel/plugins/swap && bash install.sh install 1.1
else
...
if [ ! -d /www/server/phpmyadmin ];then
	cd /www/server/yufeng_panel/plugins/phpmyadmin && bash install.sh install 4.4.15
else
